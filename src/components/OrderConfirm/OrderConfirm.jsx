        ...
        <div className={styles.orderConfirm}>
            <Row justify="center">
                <Col span={20}>
                    <Row>
                        <Col span={14}>
                            <div className={styles.containerLeft} style={{ textAlign: "center", marginRight: '70px' }}>
                                ...
                                <div className={styles.bookingContent1}>
                                    <div className={styles.bookingDetail}>
                                        <img style={{ width: "28px", height: "28px" }} src={user} alt="people" />
                                        <div className={styles.bookingDetailColumn}>
                                            <p
                                                className={styles.bookingDetailConfirm}
                                            >
                                                Full Name
                                            </p>
                                            <p
                                                className={styles.bookingDetailConfirm1}
                                            >
                                                {userData?.fullName}
                                            </p>
                                        </div>
                                    ...
                                    <div className={styles.bookingDetail}>
                                        <img style={{ width: "25px", height: "25px" }} src={phone} alt="people" />
                                        <div className={styles.bookingDetailColumn}>
                                            <p
                                                className={styles.bookingDetailConfirm}
                                            >
                                    ...
                                    <div className={styles.bookingDetail}>
                                        <img style={{ width: "25px", height: "25px" }} src={table} alt="people" />
                                        <div className={styles.bookingDetailColumn}>
                                            <p
                                                className={styles.bookingDetailConfirm}
                                            >
